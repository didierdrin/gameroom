...
// function * watchForSpawnCoin() {
//   while (true) {
//     yield take(ActionTypes.SPAWN_COIN);
//     yield call(spawnCoinSaga);
//   }
// }
...
// function * watchForMoveCoin() {
//   while (true) {
//     yield take(ActionTypes.MOVE_COIN);
//     yield call(moveCoinSaga);
//   }
// }
...
//   // const movableCoins: ICoin['coinID'][] = yield call(getMovableCoins, currentDieRoll);
//   // const isCurrentMovePossible: boolean = yield call(isCurrentMoveValid, coinID, currentDieRoll);
//   const movableCoins: ICoin['coinID'][] = yield call(getMovableCoins as any, currentDieRoll);
//   const isCurrentMovePossible: boolean = yield call(isCurrentMoveValid as any, coinID, currentDieRoll);
...
// function * watchForSetPlayers() {
//   while (true) {
//     yield take(ActionTypes.SET_PLAYERS);
//     yield call(setPlayersSaga);
//   }
// }
...
// function * watchForHomeCoin() {
//   while (true) {
//     yield take(ActionTypes.HOME_COIN);
//     yield call(homeCoinSaga);
//   }
// }

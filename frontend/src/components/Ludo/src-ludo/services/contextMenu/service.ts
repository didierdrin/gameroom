...
export const showContextMenu = (x: number, y: number, menuContents: IMenuContent[]) => dispatch(showContextMenuAction(x, y, menuContents) as any);
export const hideContextMenu = () => dispatch(hideContextMenuAction() as any);

...
//               <div
//                 key={`${coin.playerIndex}-${coin.coinIndex}`}
//                 className={`w-7 h-7 rounded-full border-3 border-white text-xs font-bold text-white flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-125 shadow-lg ${
...
//                     player.color === 'green' ? 'bg-green-500' : 'bg-yellow-400'
//                   }`}
//                 />
//                 <span className="text-white font-semibold">{player.name}</span>
//               </div>
...
//           </div>
//           <div className="p-4 bg-white/10 rounded-2xl backdrop-blur-sm border border-white/20">
//             <h4 className="font-bold text-white mb-3 text-lg">⭐ Special Moves</h4>
//             <p className="text-purple-200">Safe zones protect your coins. Three consecutive 6s lose your turn. Get extra turns for 6s!</p>
//           </div>
//           <div className="p-4 bg-white/10 rounded-2xl backdrop-blur-sm border border-white/20">
//             <h4 className="font-bold text-white mb-3 text-lg">🏆 Points System</h4>
//             <p className="text-purple-200">Winner: 10pts, 2nd: 5pts, 3rd: 2pts, 4th: 1pt. Strategy matters!</p>
...
//       {/* Player list */}
//       <div className="mt-8 w-full max-w-2xl">
//         <h3 className="text-2xl font-bold mb-4 text-white text-center">Players</h3>
//         <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//           {players.map((player, index) => {
//             const PlayerNameDisplay = ({ playerId }: { playerId: string }) => {
//               const { username: playerName, isLoading } = useUsername(playerId);
...
//                     </p>
//                     <p className="text-purple-200">
//                       Coins Home: {coins![player.id]?.filter(pos => pos === 57).length || 0}/4
//                     </p>
//                   </div>
//                 </div>
//               </div>

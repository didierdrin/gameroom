...
//       } catch (error) {
//         console.error('Error accessing media:', error);
//         // Handle cases where no media devices are available
//         setParticipants(prev => prev.filter(p => !p.isLocal));
//         setLocalStream(null);
//       }
//     };
...
//     const handleReturnedSignal = async ({
//       signal,
//       id,
//     }: {
//       signal: any;
...
//                   ...p,
//                   videoStream:
//                     stream.getVideoTracks().length > 0 ? stream : p.videoStream,
//                   audioStream:
//                     stream.getAudioTracks().length > 0 ? stream : p.audioStream,
//                   videoEnabled: stream.getVideoTracks().length > 0,
//                   audioEnabled: stream.getAudioTracks().length > 0,
//                 }
//               : p

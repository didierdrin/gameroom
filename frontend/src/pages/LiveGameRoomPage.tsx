...
export const LiveGameRoomPage = () => {
  ...
  const renderGameContent = () => {
    ...
    switch (lowerCaseGameType) {
      ...
      case 'trivia':
        return <TriviaGame socket={socket} roomId={roomId!} currentPlayer={user!.id} gameState={gameState} />;
      ...
      <div className="flex flex-1 overflow-hidden">
        {showPlayers && (
          <div className="w-full sm:w-64 border-r border-gray-700 bg-gray-800 overflow-y-auto fixed sm:relative inset-y-0 left-0 z-30">
            <PlayerList players={players} currentPlayerId={user!.id} currentTurn={gameState?.currentTurn} />
          </div>
        )}
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-4">
              {messages.map((msg, index) => (
                <div key={index} className="flex">
                  ...
                  <div>
                    <div className="text-sm font-medium">{playerIdToUsername[msg.playerId] || msg.playerId}</div>

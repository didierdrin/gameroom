...
export const LeaderboardPage = () => {
  ...
  const renderTopThree = () => {
    ...
    return (
      <div className="flex flex-row md:flex-row justify-center items-end mb-8 lg:mb-12 gap-4 lg:gap-8 px-4">
          ...
          <div className="flex flex-col items-center order-1 lg:order-2 -mt-4 sm:-mt-8 z-10">
            <div className="relative">
              <div className="absolute -top-4 sm:-top-6 left-1/2 transform -translate-x-1/2">
                <TrophyIcon size={24} className="sm:size-32 text-yellow-500" />
              </div>
              <img 
                src={first.avatar} 
                alt={first.username} 
